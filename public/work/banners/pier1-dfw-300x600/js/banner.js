...
Banner.prototype.onVisible = function () {
  ...
  this.politeLoad(['https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.3/TweenLite.min.js', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.3/TimelineLite.min.js', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.3/plugins/CSSPlugin.min.js', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.3/easing/EasePack.min.js'], function () {
    _this.start();
  });
};
