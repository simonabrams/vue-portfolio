(function() {
    ...
    function main() {
        ...
        mainTl
            .set(chase_logo, {x: 64, y: 226})
            // add a start label
            .add("start", 0.5)
            .set(banner, {autoAlpha: 1})
            // show the card
            .fromTo(card, 0.75, {x:38, y:300, force3D: true, rotateZ:0.001},{y: 82, ease:Power3.easeOut}, "start+=0.2")
            // show the bottom white footer area
            .fromTo(bottom_white, 0.5, {y: HEIGHT}, {y: 182, transformOrigin:"bottom", ease:Power3.easeOut}, "start+=0.2")
            // show the logo
            .from(chase_logo, 0.4, {y:"+=30", autoAlpha: 0, ease:Power3.easeOut}, "start+=0.4")
            ...
            .set(bg, {scale: 1.5, transformOrigin:"5% 100%", left: "50%", marginLeft:"-50%"}, "frame2+=0.2")
            ...
            // move the logo left
            .to(chase_logo, 0.4, {x:9, ease:Power1.easeOut}, "frame2+=0.2")
            ...
            // scale card
            .to(card, 0.4, {scale:0.87, x:41, y:86, ease:Power3.easeOut}, "endframe+1")
