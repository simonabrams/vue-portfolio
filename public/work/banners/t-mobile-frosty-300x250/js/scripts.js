...
(function() {
    ...
    mainTl
        ...
        .to(logo, 0.2, {autoAlpha:1}, "imageOut+=0.5")
        ...
        .from(wendys, 0.5, {autoAlpha:0, scale:0, ease:Back.easeOut}, 'imageOut+=1.4')
        .from(legal, 0.5, {autoAlpha:0}, 'imageOut+=1')
        
        // endframe
        .add("endFrame", 14)
        .from('#endFrameBg', 0.75, {autoAlpha:0, ease:Power1.easeOut}, "endFrame")
        .from([headline, subhead], 0.5, {y:HEIGHT, ease:Strong.easeOut}, "endFrame+=0.5")
